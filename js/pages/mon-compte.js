    ...
    return `
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:28px;flex-wrap:wrap;gap:14px;">
        <div>
          ...
          <div style="font-size:28px;font-weight:800;color:var(--text-primary);letter-spacing:-.6px;margin-top:2px;display:flex;align-items:center;gap:12px;">
            <iconify-icon icon="solar:user-circle-bold-duotone" style="color:#E8543A;"></iconify-icon> Mon compte
          </div>
        </div>
      </div>
      ...
      <div class="d-card" style="margin-bottom:16px;">
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;">
          <div style="width:56px;height:56px;border-radius:16px;background:linear-gradient(135deg,#E8543A,#D23E22);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;font-weight:800;">
          ...
          <div>
            ...
            <div style="margin-top:4px;">
              <span style="font-size:11px;font-weight:600;padding:3px 10px;border-radius:12px;background:rgba(232,84,58,.1);color:#E8543A;">${session.role === 'admin' ? 'Administrateur' : session.role === 'manager' ? 'Manager' : session.role || 'Utilisateur'}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="d-card" style="margin-bottom:16px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(232,84,58,.1);display:flex;align-items:center;justify-content:center;color:#E8543A;font-size:16px;">
      ...
      <div class="d-card" style="margin-bottom:16px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(139,92,246,.1);display:flex;align-items:center;justify-content:center;color:#E8543A;font-size:16px;">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;">
          <label style="flex:1;min-width:100px;display:flex;align-items:center;gap:10px;padding:12px 16px;border-radius:12px;border:2px solid ${theme === 'dark' ? '#E8543A' : 'var(--border-color)'};cursor:pointer;transition:all .2s;background:var(--bg-secondary);">
            <input type="radio" name="mc-theme" value="dark" ${theme === 'dark' ? 'checked' : ''} style="accent-color:#E8543A;">
            <div>
              <iconify-icon icon="solar:moon-bold-duotone" style="font-size:18px;color:#E8543A;"></iconify-icon>
              <div style="font-size:12px;font-weight:600;margin-top:2px;">Sombre</div>
            </div>
          </label>
          <label style="flex:1;min-width:100px;display:flex;align-items:center;gap:10px;padding:12px 16px;border-radius:12px;border:2px solid ${theme === 'light' ? '#E8543A' : 'var(--border-color)'};cursor:pointer;transition:all .2s;background:var(--bg-secondary);">
            <input type="radio" name="mc-theme" value="light" ${theme === 'light' ? 'checked' : ''} style="accent-color:#E8543A;">
            <div>
          ...
          <label style="flex:1;min-width:100px;display:flex;align-items:center;gap:10px;padding:12px 16px;border-radius:12px;border:2px solid ${theme === 'auto' ? '#E8543A' : 'var(--border-color)'};cursor:pointer;transition:all .2s;background:var(--bg-secondary);">
            <input type="radio" name="mc-theme" value="auto" ${theme === 'auto' ? 'checked' : ''} style="accent-color:#E8543A;">
            <div>
      ...
      <style>
        ...
        .mc-toggle input:checked + .mc-toggle-slider { background:#E8543A;border-color:#E8543A; }
