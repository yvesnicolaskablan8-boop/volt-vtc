...
const MenuPage = {
  render() {
    ...
    const menuItems = [
      ...
      { route: '/taches', icon: 'solar:checklist-bold-duotone', label: 'Taches', color: '#E8543A' },
      ...
      { route: '/rentabilite', icon: 'solar:pie-chart-2-bold-duotone', label: 'Rentabilité', color: '#E8543A' },
      ...
      { route: '/controle-conduite', icon: 'solar:shield-check-bold-duotone', label: 'Contr\u00f4le conduite', color: '#E8543A' },
      ...
      { route: '/rapports', icon: 'solar:file-download-bold-duotone', label: 'Rapports', color: '#E8543A' },
      { route: '/mon-compte', icon: 'solar:user-circle-bold-duotone', label: 'Mon compte', color: '#E8543A' },
