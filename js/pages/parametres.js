    ...
    return `
      <div class="grid-2" style="gap:var(--space-lg);">
        ...
        <div>
          ...
          <div class="card">
            <div class="card-header">
              <span class="card-title"><iconify-icon icon="solar:user-id-bold-duotone" style="color:#F5512E;"></iconify-icon> Expiration documents</span>
            </div>
            <div style="display:flex;flex-direction:column;gap:var(--space-sm);padding-top:var(--space-md);">
              <div style="display:flex;justify-content:space-between;align-items:center;padding:8px 0;">
                <div>
      ...
      '<div class="card">' +
        '<div class="card-header" style="display:flex;align-items:center;justify-content:space-between;">' +
          '<span class="card-title" style="display:flex;align-items:center;gap:8px;">' +
            '<iconify-icon icon="solar:wallet-money-bold-duotone" style="font-size:24px;color:#DE3E1E;"></iconify-icon> Wave Money' +
          '</span>' +
