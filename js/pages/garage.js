...
const GaragePage = {
  ...
  _addMaintenance() {
    ...
    Modal.form(
      '<iconify-icon icon="solar:tuning-2-bold-duotone" style="color:#E8543A"></iconify-icon> Planifier une maintenance',
    ...
    if (ctx && tcoData.length > 0) {
      ...
      this._charts.push(new Chart(ctx, {
        ...
        data: {
          labels,
          datasets: [
            { label:'Achat', data:tcoData.map(t=>t.achat), backgroundColor:'#E8543A', borderRadius:2 },
