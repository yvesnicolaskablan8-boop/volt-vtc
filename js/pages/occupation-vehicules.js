...
const OccupationVehiculesPage = {
  ...
  _chColor(id) {
    const pal = ['#E8543A', '#13DEB9', '#E8543A', '#f97316', '#06b6d4', '#ec4899', '#eab308', '#0a9d78', '#e0603a', '#635BFF'];
    ...
    return `
      ...
      <div class="ov-card">
        ...
        <div class="ov-legend">
          ...
          <span class="ov-lg"><span class="ov-sw" style="background:#E8543A;"></span>Chauffeur affecté</span>
