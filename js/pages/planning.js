...
const PlanningPage = {
      ...
      if (chauffeurs && chauffeurs.length) {
        ...
        if (!pret && this._essaisChargement <= 8) {
          ...
          avis = cadre('var(--bg-tertiary)', 'var(--border-color)', 'var(--text-secondary)',
            `<div class="spinner" style="width:18px;height:18px;border:2px solid var(--border-color);border-top-color:#E8543A;border-radius:50%;animation:spin 1s linear infinite;flex:none;"></div>
  ...
  _absenceTypeColor(type) {
    const colors = { repos: '#64748b', conge: '#3b82f6', maladie: '#ef4444', formation: '#f59e0b', personnel: '#E8543A', suspension: '#dc2626' };
  ...
  _shiftTypeColor(type) {
    return { matin: '#22c55e', apres_midi: '#3b82f6', journee: '#f59e0b', nuit: '#E8543A', custom: '#E8543A' }[type] || '#64748b';
  },
  ...
  _renderMobileDayView(chauffeurs, days, vehMap, stats) {
    const avatarColors = ['#E8543A','#10b981','#f59e0b','#ef4444','#3b82f6','#E8543A','#ec4899','#14b8a6','#f97316','#06b6d4'];
    ...
    html += `
      <style>
        ...
        .pm-head.today { color:#E8543A; background:rgba(232,84,58,.08); border-radius:8px 8px 0 0; border-bottom:2px solid #E8543A; }
        .pm-head .pm-daynum { display:block; font-size:16px; font-weight:800; color:var(--text-primary); margin-top:2px; }
        .pm-head.today .pm-daynum { color:#E8543A; }
        ...
        .pm-shift { background:linear-gradient(135deg,rgba(232,84,58,.15),rgba(139,92,246,.1)); color:#E8543A; }
        ...
        .pm-shift-n { background:linear-gradient(135deg,rgba(139,92,246,.15),rgba(139,92,246,.08)); color:#E8543A; }
      ...
      <div class="card" style="padding:12px;border-radius:16px;">
        ...
        <div style="display:flex;gap:8px;margin-top:14px;flex-wrap:wrap;justify-content:center;">
          ...
          <div style="display:flex;align-items:center;gap:4px;font-size:11px;font-weight:600;color:#E8543A;"><span style="width:7px;height:7px;border-radius:50%;background:#E8543A;"></span>Nuit</div>
  ...
  _renderDesktopGridView(chauffeurs, days, vehMap, stats, todayStr, versements) {
    ...
    return `
      <style>
        ...
        .pg-shift-nuit { background:linear-gradient(135deg,rgba(139,92,246,.18),rgba(167,139,250,.1)); color:#E8543A; }
        .pg-shift-custom { background:linear-gradient(135deg,rgba(232,84,58,.15),rgba(139,92,246,.1)); color:#E8543A; }
        ...
        .pg-shift-custom:hover { background:linear-gradient(135deg,rgba(232,84,58,.25),rgba(139,92,246,.18)); }
        ...
        [data-theme="dark"] .pg-shift-custom { background:linear-gradient(135deg,rgba(232,84,58,.22),rgba(139,92,246,.15)); }
        ...
        .pg-empty:hover { background:rgba(232,84,58,.06); }
        [data-theme="dark"] .pg-empty { background:rgba(255,255,255,.02); }
        [data-theme="dark"] .pg-empty:hover { background:rgba(232,84,58,.08); }
      ...
      <div class="card pg-card" style="padding:24px 20px;border-radius:16px;overflow-x:auto;-webkit-overflow-scrolling:touch;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
          <div style="display:flex;align-items:center;gap:12px;">
            <div class="pg-header-icon" style="width:38px;height:38px;border-radius:12px;background:linear-gradient(135deg,#E8543A,#D23E22);display:flex;align-items:center;justify-content:center;box-shadow:0 3px 10px rgba(232,84,58,.25);">
        ...
        <div style="display:flex;gap:8px;margin-top:16px;flex-wrap:wrap;justify-content:center;">
          ...
          <div style="display:flex;align-items:center;gap:5px;padding:4px 12px;border-radius:20px;background:rgba(139,92,246,.08);font-size:11px;font-weight:600;color:#E8543A;"><span style="width:6px;height:6px;border-radius:50%;background:#E8543A;"></span> Nuit</div>
          <div style="display:flex;align-items:center;gap:5px;padding:4px 12px;border-radius:20px;background:rgba(232,84,58,.08);font-size:11px;font-weight:600;color:#E8543A;"><span style="width:6px;height:6px;border-radius:50%;background:#E8543A;"></span> Perso.</div>
  ...
  _pcalCss() {
    return `<style>
      ...
      .pcal-cell-today { background:rgba(232,84,58,.07); border-color:rgba(232,84,58,.45); }
      .pcal-num { font-size:13px; font-weight:600; color:var(--text-primary); line-height:26px; }
      .pcal-num-out { color:var(--text-muted); }
      .pcal-today { display:inline-flex; align-items:center; justify-content:center; width:26px; height:26px; border-radius:50%; background:var(--pilote-blue); color:#fff; font-weight:800; box-shadow:0 4px 10px rgba(232,84,58,.35); }
      ...
      .pcal-chip { display:flex; align-items:center; gap:5px; font-size:10.5px; font-weight:700; white-space:nowrap; overflow:hidden; cursor:pointer;
        ...
        color:color-mix(in srgb, var(--c, #E8543A) 72%, var(--text-primary));
        background:var(--bg-tertiary);
        background:color-mix(in srgb, var(--c, #E8543A) 13%, transparent);
        border-left:3px solid var(--c, #E8543A); border-radius:5px; padding:3px 8px;
        transition:background .12s, box-shadow .12s, transform .12s; }
      .pcal-chip:hover { background:color-mix(in srgb, var(--c, #E8543A) 22%, transparent);
      ...
      .pcal-ev { display:flex; flex-direction:column; gap:1px; padding:4px 8px; border-radius:8px; border:1px solid var(--border-color); border-left:3px solid var(--c,#E8543A); background:color-mix(in srgb, var(--c,#E8543A) 8%, var(--bg-secondary)); cursor:pointer; overflow:hidden; transition:background .12s, box-shadow .12s, transform .12s; }
      .pcal-ev:hover { background:color-mix(in srgb, var(--c,#E8543A) 16%, var(--bg-secondary)); box-shadow:0 2px 8px rgba(37,83,185,.14); transform:translateX(1px); }
