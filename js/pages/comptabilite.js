...
const ComptabilitePage = {
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:28px;flex-wrap:wrap;gap:14px;">
        <div>
          ...
          <div style="font-size:28px;font-weight:800;color:var(--text-primary);letter-spacing:-.6px;margin-top:2px;display:flex;align-items:center;gap:12px;">
            <iconify-icon icon="solar:calculator-bold-duotone" style="color:#E8543A;"></iconify-icon> Comptabilité
          </div>
        </div>
    ...
    return `
      ...
      <div class="d-card" style="margin-bottom:24px;">
        <div style="display:flex;align-items:center;gap:16px;">
          <div class="d-icon" style="background:rgba(232,84,58,.12);color:#E8543A;width:48px;height:48px;font-size:20px;"><iconify-icon icon="solar:lightbulb-bold-duotone"></iconify-icon></div>
          <div style="flex:1;">
            ...
            <p style="font-size:13px;line-height:1.6;color:var(--text-secondary);">
              ...
              <strong style="color:#E8543A;">Bénéfice</strong> = Encaissements − Décaissements. Si positif, vous gagnez de l'argent !
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="d-card">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
          <div style="display:flex;align-items:center;gap:10px;">
            <div class="d-icon" style="background:rgba(232,84,58,.12);color:#E8543A;width:32px;height:32px;font-size:14px;"><iconify-icon icon="solar:list-bold-duotone"></iconify-icon></div>
            <span style="font-weight:700;font-size:14px;">Dernières opérations</span>
          </div>
          <button class="btn btn-sm" onclick="document.querySelector('[data-tab=journal]').click()" style="border-radius:12px;background:rgba(232,84,58,.1);color:#E8543A;border:none;font-size:12px;padding:6px 14px;">Voir tout</button>
        </div>
  ...
  _cptSynthese() {
    ...
    const catColors = ['#E8543A', '#f59e0b', '#ef4444', '#E8543A', '#13DEB9', '#ec4899', '#06b6d4'];
    const catMap = {};
  ...
  _cptStyles() {
    return `<style>
      ...
      .cpt-info-icon { width:30px; height:30px; border-radius:9px; background:rgba(232,84,58,.14); color:#E8543A; display:flex; align-items:center; justify-content:center; font-size:16px; }
  ...
  _loadOverviewCharts() {
    ...
    const catColors = ['#ef4444', '#f59e0b', '#3b82f6', '#E8543A', '#ec4899', '#22d3ee', '#14b8a6', '#f97316', '#E8543A', '#84cc16', '#64748b'];
  ...
  _renderCategories() {
    const recCats = [
      ...
      { id: 'frais_service', label: 'Frais de service', desc: 'Frais de service des plateformes (Yango, Bolt)', icon: 'solar:smartphone-bold-duotone', color: '#E8543A' },
    ...
    const depCats = [
      ...
      { id: 'leasing', label: 'Leasing véhicules', desc: 'Mensualités de crédit-bail', icon: 'solar:document-bold-duotone', color: '#E8543A' },
      ...
      { id: 'taxes_impots', label: 'Impôts / Taxes', desc: 'Patente, impôts, taxes diverses', icon: 'solar:bank-bold-duotone', color: '#E8543A' },
