...
const VehiculesPage = {
    ...
    if (typeof GaragePage !== 'undefined') {
      ...
      if (actions) {
        actions.innerHTML = `
          ...
          <button class="btn btn-success" onclick="GaragePage._addMaintenance()">
            <iconify-icon icon="solar:tuning-2-bold-duotone"></iconify-icon> Maintenance
          </button>
          <button class="btn btn-warning" onclick="GaragePage._addReparation()">
            <iconify-icon icon="solar:wrench-bold-duotone"></iconify-icon> Réparation
          </button>
          <button class="btn btn-primary" onclick="GaragePage._addCT()">
  ...
  _getFormFields() {
    ...
    return [
      ...
      { name: 'recetteNuit', label: 'Recette du service NUIT (FCFA)', type: 'number', min: 0, step: 1000, placeholder: 'Ex: 18000' },
      { type: 'row-end' },
      { type: 'row-start' },
      { name: 'heureDebutJour', label: 'Jour — début', type: 'time', default: '06:00' },
      { name: 'heureFinJour', label: 'Jour — fin', type: 'time', default: '21:00' },
      { name: 'heureDebutNuit', label: 'Nuit — début', type: 'time', default: '22:00' },
      { name: 'heureFinNuit', label: 'Nuit — fin', type: 'time', default: '05:00' },
      { type: 'row-end' },
      { type: 'row-start' },
