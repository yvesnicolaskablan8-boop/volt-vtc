    ...
    <div class="classement-page">
      <div class="classement-header">
        ...
        <div class="classement-header-right" style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
          ...
          <button id="classement-config-btn" class="btn btn-sm" style="display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#F5512E,#8AA8FF);color:#fff;border:none;border-radius:10px;padding:9px 16px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;box-shadow:0 2px 8px rgba(245,81,46,.25);">
      ...
      <div class="classement-legend">
        ...
        <div class="classement-legend-item">
          <iconify-icon icon="solar:steering-wheel-bold-duotone" style="color:#F5512E;"></iconify-icon>
    ...
    return `<div class="d-card" style="padding:20px;">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
        <div style="display:flex;align-items:center;gap:10px;">
          <iconify-icon icon="solar:settings-bold-duotone" style="font-size:20px;color:#F5512E;"></iconify-icon>
          <div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:14px;margin-bottom:16px;">
        ...
        <div>
          <label style="${labelStyle}"><iconify-icon icon="solar:steering-wheel-bold-duotone" style="color:#F5512E;font-size:13px;vertical-align:middle;"></iconify-icon> Conduite (%)</label>
      ...
      <div style="display:flex;justify-content:flex-end;gap:10px;">
        <button id="cfg-save-btn" class="btn" style="background:linear-gradient(135deg,#F5512E,#8AA8FF);color:#fff;border:none;border-radius:10px;padding:10px 24px;font-weight:700;font-size:13px;cursor:pointer;">
