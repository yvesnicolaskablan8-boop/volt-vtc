/**
 * DashboardPage - Main dashboard with KPIs and interactive charts
 */
const DashboardPage = {
  _charts: [],
  ...
  _getData() {
    ...
    const coursesByType = {};
    const typeLabels = {
      aeroport: 'Aéroport', gare: 'Gare', urbain: 'Urbain',
    ...
    const vehicleProfit = vehicules.map(v => {
      ...
      const monthlyCost = v.typeAcquisition === 'leasing'
        ...
        : (v.prixAchat / 60) + (v.primeAnnuelle / 12); // 5-year depreciation
      const isEV = v.typeEnergie === 'electrique';
      return {
        label: `${v.marque} ${v.modele}${isEV ? ' ⚡' : ''}`,
        profit: Math.round(revenue * 0.20 - monthlyCost), // Company's 20% commission minus costs
        isEV
      };
    });
    ...
    return `
      ...
      <div class="grid-4">
        ...
        <div class="kpi-card green">
          ...
          <div class="kpi-label">Versements reçus ce mois</div>
      ...
      <div class="charts-grid">
        <div class="chart-card full-width">
          <div class="chart-header">
            <div class="chart-title"><i class="fas fa-chart-line"></i> Évolution du chiffre d'affaires</div>
          </div>
      ...
      <div class="charts-grid" style="margin-top: var(--space-lg);">
        <div class="chart-card">
          <div class="chart-header">
            <div class="chart-title"><i class="fas fa-chart-bar"></i> Rentabilité par véhicule</div>
          </div>
          <div class="chart-container" style="height: 280px;">
  ...
  _loadCharts(d) {
    ...
    // ======= 1. Revenue chart (line) — Enriched tooltips =======
    ...
    // ======= 2. Weekly payments chart (bar) — Enriched tooltips =======
    ...
    // ======= 3. Rides by type chart (doughnut) — Center text + Enriched tooltips =======
    ...
    // ======= 4. Vehicle profitability (horizontal bar) — Enriched tooltips =======
